...
class __$$PaymentKind_OnchainImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$PaymentKind_OnchainImpl(
      txid: null == txid
          ? _value.txid
...
class _$PaymentKind_OnchainImpl extends PaymentKind_Onchain {
  const _$PaymentKind_OnchainImpl({required this.txid, required this.status})
      : super._();
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PaymentKind_OnchainImplCopyWith<_$PaymentKind_OnchainImpl> get copyWith =>
      __$$PaymentKind_OnchainImplCopyWithImpl<_$PaymentKind_OnchainImpl>(
          this, _$identity);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return onchain?.call(txid, status);
  }
...
abstract class PaymentKind_Onchain extends PaymentKind {
  const factory PaymentKind_Onchain(
      {required final Txid txid,
      required final ConfirmationStatus status}) = _$PaymentKind_OnchainImpl;
  ...
  $Res call({
    ...
    return _then(_$PaymentKind_Bolt11JitImpl(
      ...
      counterpartySkimmedFeeMsat: freezed == counterpartySkimmedFeeMsat
          ? _value.counterpartySkimmedFeeMsat
...
class _$PaymentKind_Bolt11JitImpl extends PaymentKind_Bolt11Jit {
  ...
  TResult when<TResult extends Object?>({
    ...
    return bolt11Jit(
        hash, preimage, secret, lspFeeLimits, counterpartySkimmedFeeMsat);
  }
...
abstract class PaymentKind_Bolt11Jit extends PaymentKind {
  const factory PaymentKind_Bolt11Jit(
      ...
      final PaymentPreimage? preimage,
      final PaymentSecret? secret,
      required final LSPFeeLimits lspFeeLimits,
      final BigInt? counterpartySkimmedFeeMsat}) = _$PaymentKind_Bolt11JitImpl;
  ...
  /// Will only be `Some` once we received the payment. Will always be `None` for LDK Node
  /// v0.4 and prior.
  BigInt? get counterpartySkimmedFeeMsat;
