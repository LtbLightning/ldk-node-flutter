...
class NodePointer {
  ...
  /// Retrieve a new on-chain/funding address.
  Future<Address> newOnchainAddress({dynamic hint}) => bridge.newOnchainAddressMethodNodePointer(
        that: this,
      );
  ...
  ///
  /// If `permanently` is set to `true`, we'll remember the peer and reconnect to it on restart.
  Future<void> connect({required PublicKey nodeId, required NetAddress address, required bool persist, dynamic hint}) => bridge.connectMethodNodePointer(
        that: this,
        nodeId: nodeId,
        address: address,
        persist: persist,
  ...
  ///Update the config for a previously opened channel.
  ///
  Future<void> updateChannelConfig({required ChannelId channelId, required PublicKey counterpartyNodeId, required ChannelConfig channelConfig, dynamic hint}) =>
      bridge.updateChannelConfigMethodNodePointer(
        that: this,
        channelId: channelId,
        counterpartyNodeId: counterpartyNodeId,
        channelConfig: channelConfig,
  ...
  /// Send a payement given an invoice.
  Future<PaymentHash> sendPayment({required Bolt11Invoice invoice, dynamic hint}) => bridge.sendPaymentMethodNodePointer(
        that: this,
        invoice: invoice,
      );
  ...
  /// This can be used to pay a so-called "zero-amount" invoice, i.e., an invoice that leaves the
  /// amount paid to be determined by the user.
  Future<PaymentHash> sendPaymentUsingAmount({required Bolt11Invoice invoice, required int amountMsat, dynamic hint}) => bridge.sendPaymentUsingAmountMethodNodePointer(
        that: this,
        invoice: invoice,
  ...
  /// pre-flight probes.
  ///
  Future<void> sendPaymentProbe({required Bolt11Invoice invoice, dynamic hint}) => bridge.sendPaymentProbeMethodNodePointer(
        that: this,
        invoice: invoice,
      );
  ...
  ///
  ///
  Future<void> sendSpontaneousPaymentProbe({required int amountMsat, required PublicKey nodeId, dynamic hint}) => bridge.sendSpontaneousPaymentProbeMethodNodePointer(
        that: this,
        amountMsat: amountMsat,
        nodeId: nodeId,
      );
  ...
  /// Returns a payable invoice that can be used to request and receive a payment of the amount
  /// given.
  Future<Bolt11Invoice> receivePayment({required int amountMsat, required String description, required int expirySecs, dynamic hint}) => bridge.receivePaymentMethodNodePointer(
        that: this,
        amountMsat: amountMsat,
  ...
  /// Returns a payable invoice that can be used to request and receive a payment for which the
  /// amount is to be determined by the user, also known as a "zero-amount" invoice.
  Future<Bolt11Invoice> receiveVariableAmountPayment({required String description, required int expirySecs, dynamic hint}) => bridge.receiveVariableAmountPaymentMethodNodePointer(
        that: this,
        description: description,
        expirySecs: expirySecs,
      );
  ...
  /// Remove the payment with the given hash from the store.
  ///
  Future<void> removePayment({required PaymentHash paymentHash, dynamic hint}) => bridge.removePaymentMethodNodePointer(
        that: this,
        paymentHash: paymentHash,
      );
