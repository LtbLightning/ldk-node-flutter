...
class Bolt11Invoice  {
                    ...
                    const Bolt11Invoice({required this.internal ,});
...
final bool acceptUnderpayingHtlcs;
                    ...
                    const ChannelConfig({required this.forwardingFeeProportionalMillionths ,required this.forwardingFeeBaseMsat ,required this.cltvExpiryDelta ,required this.maxDustHtlcExposure ,required this.forceCloseAvoidanceMaxFeeSatoshis ,required this.acceptUnderpayingHtlcs ,});
...
///
 LogLevel logLevel;
                    ...
                    Config({required this.storageDirPath ,this.logDirPath ,required this.network ,this.listeningAddress ,required this.defaultCltvExpiryDelta ,required this.onchainWalletSyncIntervalSecs ,required this.walletSyncIntervalSecs ,required this.feeRateCacheUpdateIntervalSecs ,required this.trustedPeers0Conf ,required this.probingLiquidityLimitMultiplier ,required this.logLevel ,});
...
const factory MaxDustHTLCExposure.fixedLimitMsat(  int field0,) = MaxDustHTLCExposure_FixedLimitMsat;
...
const factory MaxDustHTLCExposure.feeRateMultiplier(  int field0,) = MaxDustHTLCExposure_FeeRateMultiplier;
                }
...
/// Send a payment given an invoice.
 Future<PaymentHash> sendPayment({ required Bolt11Invoice invoice ,dynamic hint })=>bridge.sendPaymentMethodNodePointer(that: this, invoice:invoice,);
...
/// This can be used to pay a so-called "zero-amount" invoice, i.e., an invoice that leaves the
/// amount paid to be determined by the user.
 Future<PaymentHash> sendPaymentUsingAmount({ required Bolt11Invoice invoice ,required int amountMsat ,dynamic hint })=>bridge.sendPaymentUsingAmountMethodNodePointer(that: this, invoice:invoice,amountMsat:amountMsat,);
...
/// pre-flight probes.
///
 Future<void> sendPaymentProbe({ required Bolt11Invoice invoice ,dynamic hint })=>bridge.sendPaymentProbeMethodNodePointer(that: this, invoice:invoice,);
...
///
///
 Future<void> sendSpontaneousPaymentProbe({ required int amountMsat ,required PublicKey nodeId ,dynamic hint })=>bridge.sendSpontaneousPaymentProbeMethodNodePointer(that: this, amountMsat:amountMsat,nodeId:nodeId,);

/// Returns a payable invoice that can be used to request and receive a payment of the amount
/// given.
 Future<Bolt11Invoice> receivePayment({ required int amountMsat ,required String description ,required int expirySecs ,dynamic hint })=>bridge.receivePaymentMethodNodePointer(that: this, amountMsat:amountMsat,description:description,expirySecs:expirySecs,);

/// Returns a payable invoice that can be used to request and receive a payment for which the
/// amount is to be determined by the user, also known as a "zero-amount" invoice.
 Future<Bolt11Invoice> receiveVariableAmountPayment({ required String description ,required int expirySecs ,dynamic hint })=>bridge.receiveVariableAmountPaymentMethodNodePointer(that: this, description:description,expirySecs:expirySecs,);
...
/// Remove the payment with the given hash from the store.
///
 Future<void> removePayment({ required PaymentHash paymentHash ,dynamic hint })=>bridge.removePaymentMethodNodePointer(that: this, paymentHash:paymentHash,);
