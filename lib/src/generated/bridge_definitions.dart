...
class LdkInvoice {
  ...
  static Future<LdkInvoice> create({required Native bridge, required String invoice, dynamic hint}) =>
      bridge.createStaticMethodLdkInvoice(invoice: invoice, hint: hint);

  static Future<int?> amountMilliSatoshis({required Native bridge, required LdkInvoice invoice, dynamic hint}) =>
      bridge.amountMilliSatoshisStaticMethodLdkInvoice(invoice: invoice, hint: hint);

  static Future<bool> isExpired({required Native bridge, required LdkInvoice invoice, dynamic hint}) =>
      bridge.isExpiredStaticMethodLdkInvoice(invoice: invoice, hint: hint);

  static Future<int> expiryTime({required Native bridge, required LdkInvoice invoice, dynamic hint}) =>
      bridge.expiryTimeStaticMethodLdkInvoice(invoice: invoice, hint: hint);

  static Future<String> paymentHash({required Native bridge, required LdkInvoice invoice, dynamic hint}) =>
      bridge.paymentHashStaticMethodLdkInvoice(invoice: invoice, hint: hint);

  static Future<String?> payeePubKey({required Native bridge, required LdkInvoice invoice, dynamic hint}) =>
      bridge.payeePubKeyStaticMethodLdkInvoice(invoice: invoice, hint: hint);

  static Future<PaymentSecret> paymentSecret({required Native bridge, required LdkInvoice invoice, dynamic hint}) =>
