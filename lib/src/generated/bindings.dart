...
Address _wire2api_address(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return Address(internal: _wire2api_String(arr[0]),);
        }
...
Bolt11Invoice _wire2api_bolt_11_invoice(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return Bolt11Invoice(internal: _wire2api_String(arr[0]),);
        }
...
ChannelDetails _wire2api_channel_details(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ChannelDetails(channelId: _wire2api_channel_id(arr[0]),
...
ChannelId _wire2api_channel_id(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return ChannelId(internal: _wire2api_u8_array_32(arr[0]),);
        }
        

Event _wire2api_event(dynamic raw) {
            switch (raw[0]) {
                case 0: return Event_PaymentSuccessful(paymentHash: _wire2api_box_autoadd_payment_hash(raw[1]),);
case 1: return Event_PaymentFailed(paymentHash: _wire2api_box_autoadd_payment_hash(raw[1]),);
case 2: return Event_PaymentReceived(paymentHash: _wire2api_box_autoadd_payment_hash(raw[1]),amountMsat: _wire2api_u64(raw[2]),);
case 3: return Event_ChannelReady(channelId: _wire2api_box_autoadd_channel_id(raw[1]),userChannelId: _wire2api_box_autoadd_user_channel_id(raw[2]),);
case 4: return Event_ChannelClosed(channelId: _wire2api_box_autoadd_channel_id(raw[1]),userChannelId: _wire2api_box_autoadd_user_channel_id(raw[2]),);
case 5: return Event_ChannelPending(channelId: _wire2api_box_autoadd_channel_id(raw[1]),userChannelId: _wire2api_box_autoadd_user_channel_id(raw[2]),formerTemporaryChannelId: _wire2api_box_autoadd_channel_id(raw[3]),counterpartyNodeId: _wire2api_box_autoadd_public_key(raw[4]),fundingTxo: _wire2api_box_autoadd_out_point(raw[5]),);
...
Mnemonic _wire2api_mnemonic(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return Mnemonic(internal: _wire2api_String(arr[0]),);
        }
        

NetAddress _wire2api_net_address(dynamic raw) {
            switch (raw[0]) {
                case 0: return NetAddress_IPv4(addr: _wire2api_String(raw[1]),port: _wire2api_u16(raw[2]),);
case 1: return NetAddress_IPv6(addr: _wire2api_String(raw[1]),port: _wire2api_u16(raw[2]),);
                default: throw Exception("unreachable");
            }
        }
...
NodePointer _wire2api_node_pointer(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return NodePointer(bridge: this,
...
OutPoint _wire2api_out_point(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return OutPoint(txid: _wire2api_txid(arr[0]),
...
PaymentDetails _wire2api_payment_details(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return PaymentDetails(hash: _wire2api_payment_hash(arr[0]),
...
PaymentHash _wire2api_payment_hash(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return PaymentHash(internal: _wire2api_u8_array_32(arr[0]),);
        }
...
PaymentPreimage _wire2api_payment_preimage(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return PaymentPreimage(internal: _wire2api_u8_array_32(arr[0]),);
        }
...
PaymentSecret _wire2api_payment_secret(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return PaymentSecret(internal: _wire2api_u8_array_32(arr[0]),);
        }
...
PeerDetails _wire2api_peer_details(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return PeerDetails(nodeId: _wire2api_public_key(arr[0]),
...
PublicKey _wire2api_public_key(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return PublicKey(internal: _wire2api_String(arr[0]),);
        }
...
Txid _wire2api_txid(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return Txid(internal: _wire2api_String(arr[0]),);
        }
...
UserChannelId _wire2api_user_channel_id(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return UserChannelId(internal: _wire2api_u64(arr[0]),);
        }
...
void _api_fill_to_wire_gossip_source_config(GossipSourceConfig apiObj, wire_GossipSourceConfig wireObj) {
                if (apiObj is GossipSourceConfig_P2PNetwork) { wireObj.tag = 0; return; }
...
class RustLdkNodeWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_send_spontaneous_payment_probe__method__NodePointer =
      _wire_send_spontaneous_payment_probe__method__NodePointerPtr.asFunction<
          void Function(int, ffi.Pointer<wire_NodePointer>, int,
              ffi.Pointer<wire_PublicKey>)>();
  ...
  late final _new_box_autoadd_chain_data_source_config_0Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_ChainDataSourceConfig>
              Function()>>('new_box_autoadd_chain_data_source_config_0');
  ...
  late final _inflate_ChainDataSourceConfig_EsploraPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ChainDataSourceConfigKind>
              Function()>>('inflate_ChainDataSourceConfig_Esplora');
