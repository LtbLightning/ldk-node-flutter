...
class RustLdkNodeImpl implements RustLdkNode {
  ...
  FlutterRustBridgeTaskConstMeta get kGenerateEntropyMnemonicConstMeta => const FlutterRustBridgeTaskConstMeta(
  ...
  Future<Address> newOnchainAddressMethodNodePointer({required NodePointer that, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_new_onchain_address__method__NodePointer(port_, arg0),
  ...
  FlutterRustBridgeTaskConstMeta get kNewOnchainAddressMethodNodePointerConstMeta => const FlutterRustBridgeTaskConstMeta(
  ...
  Future<Txid> sendToOnchainAddressMethodNodePointer({required NodePointer that, required Address address, required int amountSats, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_send_to_onchain_address__method__NodePointer(port_, arg0, arg1, arg2),
  ...
  Future<Txid> sendAllToOnchainAddressMethodNodePointer({required NodePointer that, required Address address, dynamic hint}) {
    ...
    var arg1 = _platform.api2wire_box_autoadd_address(address);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_send_all_to_onchain_address__method__NodePointer(port_, arg0, arg1),
      parseSuccessData: _wire2api_txid,
  ...
  Future<void> connectOpenChannelMethodNodePointer(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_connect_open_channel__method__NodePointer(port_, arg0, arg1, arg2, arg3, arg4, arg5, arg6),
      parseSuccessData: _wire2api_unit,
      constMeta: kConnectOpenChannelMethodNodePointerConstMeta,
      argValues: [that, address, nodeId, channelAmountSats, pushToCounterpartyMsat, announceChannel, channelConfig],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kConnectOpenChannelMethodNodePointerConstMeta => const FlutterRustBridgeTaskConstMeta(
        ...
        argNames: ["that", "address", "nodeId", "channelAmountSats", "pushToCounterpartyMsat", "announceChannel", "channelConfig"],
      );
  ...
  Future<void> updateChannelConfigMethodNodePointer(
      {required NodePointer that, required ChannelId channelId, required PublicKey counterpartyNodeId, required ChannelConfig channelConfig, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
    var arg1 = _platform.api2wire_box_autoadd_channel_id(channelId);
    var arg2 = _platform.api2wire_box_autoadd_public_key(counterpartyNodeId);
    var arg3 = _platform.api2wire_box_autoadd_channel_config(channelConfig);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_update_channel_config__method__NodePointer(port_, arg0, arg1, arg2, arg3),
      parseSuccessData: _wire2api_unit,
  ...
  FlutterRustBridgeTaskConstMeta get kUpdateChannelConfigMethodNodePointerConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "update_channel_config__method__NodePointer",
        argNames: ["that", "channelId", "counterpartyNodeId", "channelConfig"],
      );

  Future<PaymentHash> sendPaymentMethodNodePointer({required NodePointer that, required Bolt11Invoice invoice, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
  ...
  Future<PaymentHash> sendPaymentUsingAmountMethodNodePointer({required NodePointer that, required Bolt11Invoice invoice, required int amountMsat, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
    var arg1 = _platform.api2wire_box_autoadd_bolt_11_invoice(invoice);
  ...
  Future<void> sendPaymentProbeMethodNodePointer({required NodePointer that, required Bolt11Invoice invoice, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
    var arg1 = _platform.api2wire_box_autoadd_bolt_11_invoice(invoice);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_send_payment_probe__method__NodePointer(port_, arg0, arg1),
      parseSuccessData: _wire2api_unit,
  ...
  FlutterRustBridgeTaskConstMeta get kSendPaymentProbeMethodNodePointerConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "send_payment_probe__method__NodePointer",
        argNames: ["that", "invoice"],
      );

  Future<void> sendSpontaneousPaymentProbeMethodNodePointer({required NodePointer that, required int amountMsat, required PublicKey nodeId, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
    var arg1 = _platform.api2wire_u64(amountMsat);
    var arg2 = _platform.api2wire_box_autoadd_public_key(nodeId);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_send_spontaneous_payment_probe__method__NodePointer(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_unit,
  ...
  FlutterRustBridgeTaskConstMeta get kSendSpontaneousPaymentProbeMethodNodePointerConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "send_spontaneous_payment_probe__method__NodePointer",
        argNames: ["that", "amountMsat", "nodeId"],
      );

  Future<Bolt11Invoice> receivePaymentMethodNodePointer({required NodePointer that, required int amountMsat, required String description, required int expirySecs, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
    var arg1 = _platform.api2wire_u64(amountMsat);
  ...
  Future<Bolt11Invoice> receiveVariableAmountPaymentMethodNodePointer({required NodePointer that, required String description, required int expirySecs, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
  ...
  Future<void> removePaymentMethodNodePointer({required NodePointer that, required PaymentHash paymentHash, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_node_pointer(that);
    var arg1 = _platform.api2wire_box_autoadd_payment_hash(paymentHash);
    return _platform.executeNormal(FlutterRustBridgeTask(
  ...
  DropFnType get dropOpaqueMutexNodeSqliteStore => _platform.inner.drop_opaque_MutexNodeSqliteStore;
  ShareFnType get shareOpaqueMutexNodeSqliteStore => _platform.inner.share_opaque_MutexNodeSqliteStore;
  OpaqueTypeFinalizer get MutexNodeSqliteStoreFinalizer => _platform.MutexNodeSqliteStoreFinalizer;
...
// Section: api2wire
  ...
  @protected
  wire_MutexNodeSqliteStore api2wire_MutexNodeSqliteStore(MutexNodeSqliteStore raw) {
  ...
  @protected
  ffi.Pointer<wire_Bolt11Invoice> api2wire_box_autoadd_bolt_11_invoice(Bolt11Invoice raw) {
  ...
  @protected
  ffi.Pointer<wire_ChannelConfig> api2wire_box_autoadd_channel_config(ChannelConfig raw) {
  ...
  @protected
  ffi.Pointer<wire_list_public_key> api2wire_list_public_key(List<PublicKey> raw) {
  ...
  @protected
  ffi.Pointer<wire_ChannelConfig> api2wire_opt_box_autoadd_channel_config(ChannelConfig? raw) {
...
// Section: finalizer
  ...
  late final OpaqueTypeFinalizer _MutexNodeSqliteStoreFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_MutexNodeSqliteStorePtr);
  OpaqueTypeFinalizer get MutexNodeSqliteStoreFinalizer => _MutexNodeSqliteStoreFinalizer;
// Section: api_fill_to_wire

  void _api_fill_to_wire_MutexNodeSqliteStore(MutexNodeSqliteStore apiObj, wire_MutexNodeSqliteStore wireObj) {
  ...
  void _api_fill_to_wire_bolt_11_invoice(Bolt11Invoice apiObj, wire_Bolt11Invoice wireObj) {
    wireObj.internal = api2wire_String(apiObj.internal);
  }
  ...
  void _api_fill_to_wire_box_autoadd_bolt_11_invoice(Bolt11Invoice apiObj, ffi.Pointer<wire_Bolt11Invoice> wireObj) {
  ...
  void _api_fill_to_wire_box_autoadd_channel_config(ChannelConfig apiObj, ffi.Pointer<wire_ChannelConfig> wireObj) {
  ...
  void _api_fill_to_wire_channel_config(ChannelConfig apiObj, wire_ChannelConfig wireObj) {
    wireObj.forwarding_fee_proportional_millionths = api2wire_u32(apiObj.forwardingFeeProportionalMillionths);
    wireObj.forwarding_fee_base_msat = api2wire_u32(apiObj.forwardingFeeBaseMsat);
    wireObj.cltv_expiry_delta = api2wire_u16(apiObj.cltvExpiryDelta);
    _api_fill_to_wire_max_dust_htlc_exposure(apiObj.maxDustHtlcExposure, wireObj.max_dust_htlc_exposure);
    wireObj.force_close_avoidance_max_fee_satoshis = api2wire_u64(apiObj.forceCloseAvoidanceMaxFeeSatoshis);
    wireObj.accept_underpaying_htlcs = api2wire_bool(apiObj.acceptUnderpayingHtlcs);
  }
  ...
  void _api_fill_to_wire_config(Config apiObj, wire_Config wireObj) {
    ...
    wireObj.trusted_peers_0conf = api2wire_list_public_key(apiObj.trustedPeers0Conf);
    wireObj.probing_liquidity_limit_multiplier = api2wire_u64(apiObj.probingLiquidityLimitMultiplier);
  ...
  void _api_fill_to_wire_max_dust_htlc_exposure(MaxDustHTLCExposure apiObj, wire_MaxDustHTLCExposure wireObj) {
  ...
  void _api_fill_to_wire_opt_box_autoadd_channel_config(ChannelConfig? apiObj, ffi.Pointer<wire_ChannelConfig> wireObj) {
    if (apiObj != null) _api_fill_to_wire_box_autoadd_channel_config(apiObj, wireObj);
  }
...
class RustLdkNodeWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_generate_entropy_mnemonicPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>('wire_generate_entropy_mnemonic');
  late final _wire_generate_entropy_mnemonic = _wire_generate_entropy_mnemonicPtr.asFunction<void Function(int)>();
  ...
  late final _wire_new_onchain_address__method__NodePointer = _wire_new_onchain_address__method__NodePointerPtr.asFunction<void Function(int, ffi.Pointer<wire_NodePointer>)>();
  ...
  late final _wire_send_to_onchain_address__method__NodePointer =
      _wire_send_to_onchain_address__method__NodePointerPtr.asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_Address>, int)>();
  ...
  late final _wire_send_all_to_onchain_address__method__NodePointer =
      _wire_send_all_to_onchain_address__method__NodePointerPtr.asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_Address>)>();
  ...
  late final _wire_connect_open_channel__method__NodePointerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_NetAddress>, ffi.Pointer<wire_PublicKey>, ffi.Uint64, ffi.Pointer<ffi.Uint64>, ffi.Bool,
              ffi.Pointer<wire_ChannelConfig>)>>('wire_connect_open_channel__method__NodePointer');
  late final _wire_connect_open_channel__method__NodePointer = _wire_connect_open_channel__method__NodePointerPtr
      .asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_NetAddress>, ffi.Pointer<wire_PublicKey>, int, ffi.Pointer<ffi.Uint64>, bool, ffi.Pointer<wire_ChannelConfig>)>();
  ...
  late final _wire_update_channel_config__method__NodePointerPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_ChannelId>, ffi.Pointer<wire_PublicKey>, ffi.Pointer<wire_ChannelConfig>)>>(
          'wire_update_channel_config__method__NodePointer');
  late final _wire_update_channel_config__method__NodePointer = _wire_update_channel_config__method__NodePointerPtr
      .asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_ChannelId>, ffi.Pointer<wire_PublicKey>, ffi.Pointer<wire_ChannelConfig>)>();
  ...
  late final _wire_send_payment__method__NodePointer = _wire_send_payment__method__NodePointerPtr.asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_Bolt11Invoice>)>();
  ...
  late final _wire_send_payment_using_amount__method__NodePointer =
      _wire_send_payment_using_amount__method__NodePointerPtr.asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_Bolt11Invoice>, int)>();
  ...
  void wire_send_payment_probe__method__NodePointer(
    int port_,
    ffi.Pointer<wire_NodePointer> that,
    ffi.Pointer<wire_Bolt11Invoice> invoice,
  ) {
  ...
  late final _wire_send_payment_probe__method__NodePointer =
      _wire_send_payment_probe__method__NodePointerPtr.asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, ffi.Pointer<wire_Bolt11Invoice>)>();

  void wire_send_spontaneous_payment_probe__method__NodePointer(
    int port_,
    ffi.Pointer<wire_NodePointer> that,
    int amount_msat,
    ffi.Pointer<wire_PublicKey> node_id,
  ...
  late final _wire_send_spontaneous_payment_probe__method__NodePointer =
      _wire_send_spontaneous_payment_probe__method__NodePointerPtr.asFunction<void Function(int, ffi.Pointer<wire_NodePointer>, int, ffi.Pointer<wire_PublicKey>)>();
  ...
  late final _new_MutexNodeSqliteStorePtr = _lookup<ffi.NativeFunction<wire_MutexNodeSqliteStore Function()>>('new_MutexNodeSqliteStore');
  late final _new_MutexNodeSqliteStore = _new_MutexNodeSqliteStorePtr.asFunction<wire_MutexNodeSqliteStore Function()>();
  ...
  late final _new_box_autoadd_bolt_11_invoice_0Ptr = _lookup<ffi.NativeFunction<ffi.Pointer<wire_Bolt11Invoice> Function()>>('new_box_autoadd_bolt_11_invoice_0');
  late final _new_box_autoadd_bolt_11_invoice_0 = _new_box_autoadd_bolt_11_invoice_0Ptr.asFunction<ffi.Pointer<wire_Bolt11Invoice> Function()>();
  ...
  late final _new_box_autoadd_channel_config_0Ptr = _lookup<ffi.NativeFunction<ffi.Pointer<wire_ChannelConfig> Function()>>('new_box_autoadd_channel_config_0');
  late final _new_box_autoadd_channel_config_0 = _new_box_autoadd_channel_config_0Ptr.asFunction<ffi.Pointer<wire_ChannelConfig> Function()>();
  ...
  late final _new_list_public_key_0Ptr = _lookup<ffi.NativeFunction<ffi.Pointer<wire_list_public_key> Function(ffi.Int32)>>('new_list_public_key_0');
  late final _new_list_public_key_0 = _new_list_public_key_0Ptr.asFunction<ffi.Pointer<wire_list_public_key> Function(int)>();
  ...
  late final _drop_opaque_MutexNodeSqliteStorePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>('drop_opaque_MutexNodeSqliteStore');
  late final _drop_opaque_MutexNodeSqliteStore = _drop_opaque_MutexNodeSqliteStorePtr.asFunction<void Function(ffi.Pointer<ffi.Void>)>();
  ...
  late final _share_opaque_MutexNodeSqliteStorePtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>('share_opaque_MutexNodeSqliteStore');
  late final _share_opaque_MutexNodeSqliteStore = _share_opaque_MutexNodeSqliteStorePtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();
  ...
  ffi.Pointer<MaxDustHTLCExposureKind> inflate_MaxDustHTLCExposure_FixedLimitMsat() {
    return _inflate_MaxDustHTLCExposure_FixedLimitMsat();
  }

  late final _inflate_MaxDustHTLCExposure_FixedLimitMsatPtr = _lookup<ffi.NativeFunction<ffi.Pointer<MaxDustHTLCExposureKind> Function()>>('inflate_MaxDustHTLCExposure_FixedLimitMsat');
  late final _inflate_MaxDustHTLCExposure_FixedLimitMsat = _inflate_MaxDustHTLCExposure_FixedLimitMsatPtr.asFunction<ffi.Pointer<MaxDustHTLCExposureKind> Function()>();

  ffi.Pointer<MaxDustHTLCExposureKind> inflate_MaxDustHTLCExposure_FeeRateMultiplier() {
    return _inflate_MaxDustHTLCExposure_FeeRateMultiplier();
  }

  late final _inflate_MaxDustHTLCExposure_FeeRateMultiplierPtr = _lookup<ffi.NativeFunction<ffi.Pointer<MaxDustHTLCExposureKind> Function()>>('inflate_MaxDustHTLCExposure_FeeRateMultiplier');
  late final _inflate_MaxDustHTLCExposure_FeeRateMultiplier = _inflate_MaxDustHTLCExposure_FeeRateMultiplierPtr.asFunction<ffi.Pointer<MaxDustHTLCExposureKind> Function()>();
...
final class MaxDustHTLCExposureKind extends ffi.Union {
  ...
  external ffi.Pointer<wire_MaxDustHTLCExposure_FeeRateMultiplier> FeeRateMultiplier;
}
