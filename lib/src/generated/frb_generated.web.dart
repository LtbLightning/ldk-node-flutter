...
abstract class LdkCoreApiImplPlatform extends BaseApiImpl<LdkCoreWire> {
  ...
  @protected
  List<dynamic> cst_encode_box_autoadd_node_base(NodeBase raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return cst_encode_node_base(raw);
  }
  ...
  List<dynamic> cst_encode_closure_reason(ClosureReason raw) {
    ...
    if (raw is ClosureReason_CooperativeClosure) {
      return [2];
    }
    ...
    if (raw is ClosureReason_ProcessingError) {
      return [5, cst_encode_String(raw.err)];
    }
  ...
  List<dynamic> cst_encode_entropy_source_config(EntropySourceConfig raw) {
    ...
    if (raw is EntropySourceConfig_Bip39Mnemonic) {
      return [
        2,
        cst_encode_box_autoadd_mnemonic_base(raw.mnemonic),
  ...
  @protected
  List<dynamic> cst_encode_node_base(NodeBase raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
...
class LdkCoreWire implements BaseWire {
  ...
  void wire_MnemonicBase_generate(NativePortType port_) =>
      wasmModule.wire_MnemonicBase_generate(port_);

  void wire_NodeBase_close_channel(NativePortType port_, List<dynamic> that,
          List<dynamic> user_channel_id, List<dynamic> counterparty_node_id) =>
      wasmModule.wire_NodeBase_close_channel(
          port_, that, user_channel_id, counterparty_node_id);

  void wire_NodeBase_config(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_config(port_, that);

  void wire_NodeBase_connect(NativePortType port_, List<dynamic> that,
          List<dynamic> node_id, List<dynamic> address, bool persist) =>
      wasmModule.wire_NodeBase_connect(port_, that, node_id, address, persist);
  ...
  void wire_NodeBase_connect_open_channel(
      ...
      wasmModule.wire_NodeBase_connect_open_channel(
          port_,
          that,
          address,
          node_id,
  ...
  void wire_NodeBase_disconnect(NativePortType port_, List<dynamic> that,
          List<dynamic> counterparty_node_id) =>
      wasmModule.wire_NodeBase_disconnect(port_, that, counterparty_node_id);

  void wire_NodeBase_event_handled(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_event_handled(port_, that);

  void wire_NodeBase_list_balances(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_list_balances(port_, that);

  void wire_NodeBase_list_channels(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_list_channels(port_, that);

  void wire_NodeBase_list_payments(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_list_payments(port_, that);

  void wire_NodeBase_list_payments_with_filter(
          NativePortType port_, List<dynamic> that, int payment_direction) =>
      wasmModule.wire_NodeBase_list_payments_with_filter(
          port_, that, payment_direction);

  void wire_NodeBase_list_peers(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_list_peers(port_, that);

  void wire_NodeBase_listening_addresses(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_listening_addresses(port_, that);

  void wire_NodeBase_new_onchain_address(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_new_onchain_address(port_, that);

  void wire_NodeBase_next_event(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_next_event(port_, that);

  void wire_NodeBase_next_event_async(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_next_event_async(port_, that);

  void wire_NodeBase_node_id(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_node_id(port_, that);

  void wire_NodeBase_payment(NativePortType port_, List<dynamic> that,
          List<dynamic> payment_hash) =>
      wasmModule.wire_NodeBase_payment(port_, that, payment_hash);

  void wire_NodeBase_receive_payment(NativePortType port_, List<dynamic> that,
          Object amount_msat, String description, int expiry_secs) =>
      wasmModule.wire_NodeBase_receive_payment(
  ...
  void wire_NodeBase_receive_payment_via_jit_channel(
      ...
      wasmModule.wire_NodeBase_receive_payment_via_jit_channel(port_, that,
          amount_msat, description, expiry_secs, max_total_lsp_fee_limit_msat);

  void wire_NodeBase_receive_variable_amount_payment(NativePortType port_,
          List<dynamic> that, String description, int expiry_secs) =>
      wasmModule.wire_NodeBase_receive_variable_amount_payment(
  ...
  void wire_NodeBase_receive_variable_amount_payment_via_jit_channel(
      ...
      wasmModule.wire_NodeBase_receive_variable_amount_payment_via_jit_channel(
          port_,
          that,
          description,
          expiry_secs,
  ...
  void wire_NodeBase_remove_payment(NativePortType port_, List<dynamic> that,
          List<dynamic> payment_hash) =>
      wasmModule.wire_NodeBase_remove_payment(port_, that, payment_hash);

  void wire_NodeBase_send_all_to_onchain_address(
          NativePortType port_, List<dynamic> that, List<dynamic> address) =>
      wasmModule.wire_NodeBase_send_all_to_onchain_address(
          port_, that, address);

  void wire_NodeBase_send_payment(
          NativePortType port_, List<dynamic> that, List<dynamic> invoice) =>
      wasmModule.wire_NodeBase_send_payment(port_, that, invoice);

  void wire_NodeBase_send_payment_probes(
          NativePortType port_, List<dynamic> that, List<dynamic> invoice) =>
      wasmModule.wire_NodeBase_send_payment_probes(port_, that, invoice);

  void wire_NodeBase_send_payment_probes_using_amount(NativePortType port_,
          List<dynamic> that, List<dynamic> invoice, Object amount_msat) =>
      wasmModule.wire_NodeBase_send_payment_probes_using_amount(
          port_, that, invoice, amount_msat);

  void wire_NodeBase_send_payment_using_amount(NativePortType port_,
          List<dynamic> that, List<dynamic> invoice, Object amount_msat) =>
      wasmModule.wire_NodeBase_send_payment_using_amount(
          port_, that, invoice, amount_msat);

  void wire_NodeBase_send_spontaneous_payment(NativePortType port_,
          List<dynamic> that, Object amount_msat, List<dynamic> node_id) =>
      wasmModule.wire_NodeBase_send_spontaneous_payment(
          port_, that, amount_msat, node_id);

  void wire_NodeBase_send_spontaneous_payment_probes(NativePortType port_,
          List<dynamic> that, Object amount_msat, List<dynamic> node_id) =>
      wasmModule.wire_NodeBase_send_spontaneous_payment_probes(
          port_, that, amount_msat, node_id);

  void wire_NodeBase_send_to_onchain_address(NativePortType port_,
          List<dynamic> that, List<dynamic> address, Object amount_sats) =>
      wasmModule.wire_NodeBase_send_to_onchain_address(
          port_, that, address, amount_sats);

  void wire_NodeBase_sign_message(
          NativePortType port_, List<dynamic> that, List<int> msg) =>
      wasmModule.wire_NodeBase_sign_message(port_, that, msg);

  void wire_NodeBase_start(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_start(port_, that);

  void wire_NodeBase_status(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_status(port_, that);

  void wire_NodeBase_stop(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_stop(port_, that);

  void wire_NodeBase_sync_wallets(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_sync_wallets(port_, that);
  ...
  void wire_NodeBase_update_channel_config(
          ...
          List<dynamic> counterparty_node_id,
          List<dynamic> channel_config) =>
      wasmModule.wire_NodeBase_update_channel_config(
          port_, that, user_channel_id, counterparty_node_id, channel_config);

  void wire_NodeBase_verify_signature(NativePortType port_, List<dynamic> that,
          List<int> msg, String sig, List<dynamic> pkey) =>
      wasmModule.wire_NodeBase_verify_signature(port_, that, msg, sig, pkey);

  void wire_NodeBase_wait_next_event(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_NodeBase_wait_next_event(port_, that);
...
class LdkCoreWasmModule implements WasmModule {
  ...
  external void wire_MnemonicBase_generate(NativePortType port_);

  external void wire_NodeBase_close_channel(
      NativePortType port_,
      List<dynamic> that,
      List<dynamic> user_channel_id,
      List<dynamic> counterparty_node_id);

  external void wire_NodeBase_config(NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_connect(NativePortType port_, List<dynamic> that,
      List<dynamic> node_id, List<dynamic> address, bool persist);

  external void wire_NodeBase_connect_open_channel(
      NativePortType port_,
      List<dynamic> that,
      List<dynamic> address,
      List<dynamic> node_id,
  ...
  external void wire_NodeBase_disconnect(NativePortType port_,
      List<dynamic> that, List<dynamic> counterparty_node_id);

  external void wire_NodeBase_event_handled(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_list_balances(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_list_channels(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_list_payments(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_list_payments_with_filter(
      NativePortType port_, List<dynamic> that, int payment_direction);

  external void wire_NodeBase_list_peers(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_listening_addresses(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_new_onchain_address(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_next_event(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_next_event_async(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_node_id(NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_payment(
      NativePortType port_, List<dynamic> that, List<dynamic> payment_hash);

  external void wire_NodeBase_receive_payment(
      NativePortType port_,
      List<dynamic> that,
      Object amount_msat,
      String description,
  ...
  external void wire_NodeBase_receive_payment_via_jit_channel(
      NativePortType port_,
      List<dynamic> that,
      Object amount_msat,
      String description,
  ...
  external void wire_NodeBase_receive_variable_amount_payment(
      NativePortType port_,
      List<dynamic> that,
      String description,
      int expiry_secs);

  external void wire_NodeBase_receive_variable_amount_payment_via_jit_channel(
      NativePortType port_,
      List<dynamic> that,
      String description,
      int expiry_secs,
  ...
  external void wire_NodeBase_remove_payment(
      NativePortType port_, List<dynamic> that, List<dynamic> payment_hash);

  external void wire_NodeBase_send_all_to_onchain_address(
      NativePortType port_, List<dynamic> that, List<dynamic> address);

  external void wire_NodeBase_send_payment(
      NativePortType port_, List<dynamic> that, List<dynamic> invoice);

  external void wire_NodeBase_send_payment_probes(
      NativePortType port_, List<dynamic> that, List<dynamic> invoice);

  external void wire_NodeBase_send_payment_probes_using_amount(
      NativePortType port_,
      List<dynamic> that,
      List<dynamic> invoice,
      Object amount_msat);

  external void wire_NodeBase_send_payment_using_amount(NativePortType port_,
      List<dynamic> that, List<dynamic> invoice, Object amount_msat);

  external void wire_NodeBase_send_spontaneous_payment(NativePortType port_,
      List<dynamic> that, Object amount_msat, List<dynamic> node_id);

  external void wire_NodeBase_send_spontaneous_payment_probes(
      NativePortType port_,
      List<dynamic> that,
      Object amount_msat,
      List<dynamic> node_id);

  external void wire_NodeBase_send_to_onchain_address(NativePortType port_,
      List<dynamic> that, List<dynamic> address, Object amount_sats);

  external void wire_NodeBase_sign_message(
      NativePortType port_, List<dynamic> that, List<int> msg);

  external void wire_NodeBase_start(NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_status(NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_stop(NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_sync_wallets(
      NativePortType port_, List<dynamic> that);

  external void wire_NodeBase_update_channel_config(
      NativePortType port_,
      List<dynamic> that,
      List<dynamic> user_channel_id,
      List<dynamic> counterparty_node_id,
  ...
  external void wire_NodeBase_verify_signature(NativePortType port_,
      List<dynamic> that, List<int> msg, String sig, List<dynamic> pkey);

  external void wire_NodeBase_wait_next_event(
      NativePortType port_, List<dynamic> that);

  external void wire_finalize_builder(
      NativePortType port_,
      List<dynamic> config,
      List<dynamic>? chain_data_source_config,
      List<dynamic>? entropy_source_config,
