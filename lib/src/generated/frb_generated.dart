...
abstract class LdkCoreApi extends BaseApi {
  ...
  Future<void> ldkNodeConnectOpenChannel(
      {required LdkNode that,
  ...
  Future<bool> ldkNodeIsRunning({required LdkNode that, dynamic hint});
  ...
  Future<Address> ldkNodeNewOnchainAddress(
      {required LdkNode that, dynamic hint});
  ...
  Future<PaymentDetails?> ldkNodePayment(
      {required LdkNode that, required PaymentHash paymentHash, dynamic hint});

  Future<Bolt11Invoice> ldkNodeReceivePayment(
      {required LdkNode that,
  ...
  Future<Bolt11Invoice> ldkNodeReceiveVariableAmountPayment(
      {required LdkNode that,
      required String description,
      required int expirySecs,
      dynamic hint});
  ...
  Future<Txid> ldkNodeSendAllToOnchainAddress(
      {required LdkNode that, required Address address, dynamic hint});

  Future<PaymentHash> ldkNodeSendPayment(
      {required LdkNode that, required Bolt11Invoice invoice, dynamic hint});

  Future<void> ldkNodeSendPaymentProbes(
      {required LdkNode that, required Bolt11Invoice invoice, dynamic hint});

  Future<void> ldkNodeSendPaymentProbesUsingAmount(
      {required LdkNode that,
      required Bolt11Invoice invoice,
      required int amountMsat,
      dynamic hint});

  Future<PaymentHash> ldkNodeSendPaymentUsingAmount(
      {required LdkNode that,
      required Bolt11Invoice invoice,
      required int amountMsat,
      dynamic hint});

  Future<PaymentHash> ldkNodeSendSpontaneousPayment(
      {required LdkNode that,
      required int amountMsat,
      required PublicKey nodeId,
      dynamic hint});

  Future<void> ldkNodeSendSpontaneousPaymentProbes(
      {required LdkNode that,
      required int amountMsat,
      required PublicKey nodeId,
      dynamic hint});

  Future<Txid> ldkNodeSendToOnchainAddress(
      {required LdkNode that,
  ...
  Future<int> ldkNodeSpendableOnchainBalanceSats(
      {required LdkNode that, dynamic hint});
  ...
  Future<int> ldkNodeTotalOnchainBalanceSats(
      {required LdkNode that, dynamic hint});
  ...
  Future<String> socketAddressAsString(
...
class LdkCoreApiImpl extends LdkCoreApiImplPlatform implements LdkCoreApi {
  ...
  Future<LdkNode> buildWithSqliteStore(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_build_with_sqlite_store(port_, arg0, arg1, arg2, arg3);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_ldk_node,
        decodeErrorData: dco_decode_builder_exception,
      ),
      constMeta: kBuildWithSqliteStoreConstMeta,
      argValues: [
        config,
        chainDataSourceConfig,
        entropySourceConfig,
  ...
  TaskConstMeta get kBuildWithSqliteStoreConstMeta => const TaskConstMeta(
        debugName: "build_with_sqlite_store",
        argNames: [
          "config",
          "chainDataSourceConfig",
          "entropySourceConfig",
  ...
  Future<bool> ldkNodeIsRunning({required LdkNode that, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_ldk_node(that);
        return wire.wire_ldk_node_is_running(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_bool,
        decodeErrorData: null,
      ),
      constMeta: kLdkNodeIsRunningConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kLdkNodeIsRunningConstMeta => const TaskConstMeta(
        debugName: "ldk_node_is_running",
        argNames: ["that"],
      );
  ...
  Future<Address> ldkNodeNewOnchainAddress(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_ldk_node(that);
        return wire.wire_ldk_node_new_onchain_address(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_address,
        decodeErrorData: dco_decode_node_exception,
      ),
      constMeta: kLdkNodeNewOnchainAddressConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kLdkNodeNewOnchainAddressConstMeta => const TaskConstMeta(
        debugName: "ldk_node_new_onchain_address",
        argNames: ["that"],
      );
  ...
  Future<Bolt11Invoice> ldkNodeReceivePayment(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_ldk_node_receive_payment(
  ...
  TaskConstMeta get kLdkNodeReceivePaymentConstMeta => const TaskConstMeta(
        debugName: "ldk_node_receive_payment",
  ...
  Future<Bolt11Invoice> ldkNodeReceiveVariableAmountPayment(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_ldk_node_receive_variable_amount_payment(
      ...
      constMeta: kLdkNodeReceiveVariableAmountPaymentConstMeta,
  ...
  TaskConstMeta get kLdkNodeReceiveVariableAmountPaymentConstMeta =>
      const TaskConstMeta(
        debugName: "ldk_node_receive_variable_amount_payment",
  ...
  Future<Txid> ldkNodeSendAllToOnchainAddress(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_ldk_node_send_all_to_onchain_address(
            port_, arg0, arg1);
      },
      codec: DcoCodec(
      ...
      constMeta: kLdkNodeSendAllToOnchainAddressConstMeta,
  ...
  TaskConstMeta get kLdkNodeSendAllToOnchainAddressConstMeta =>
      const TaskConstMeta(
        debugName: "ldk_node_send_all_to_onchain_address",
  ...
  Future<PaymentHash> ldkNodeSendPayment(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_ldk_node_send_payment(port_, arg0, arg1);
      },
      codec: DcoCodec(
  ...
  TaskConstMeta get kLdkNodeSendPaymentConstMeta => const TaskConstMeta(
        debugName: "ldk_node_send_payment",
  ...
  Future<void> ldkNodeSendPaymentProbes(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_ldk_node(that);
        var arg1 = cst_encode_box_autoadd_bolt_11_invoice(invoice);
        return wire.wire_ldk_node_send_payment_probes(port_, arg0, arg1);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_unit,
        decodeErrorData: dco_decode_node_exception,
      ),
      constMeta: kLdkNodeSendPaymentProbesConstMeta,
      argValues: [that, invoice],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kLdkNodeSendPaymentProbesConstMeta => const TaskConstMeta(
        debugName: "ldk_node_send_payment_probes",
        argNames: ["that", "invoice"],
      );
  ...
  Future<void> ldkNodeSendPaymentProbesUsingAmount(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_ldk_node_send_payment_probes_using_amount(
            port_, arg0, arg1, arg2);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_unit,
      ...
      constMeta: kLdkNodeSendPaymentProbesUsingAmountConstMeta,
  ...
  TaskConstMeta get kLdkNodeSendPaymentProbesUsingAmountConstMeta =>
      const TaskConstMeta(
  ...
  Future<PaymentHash> ldkNodeSendPaymentUsingAmount(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        var arg1 = cst_encode_box_autoadd_bolt_11_invoice(invoice);
        var arg2 = cst_encode_u_64(amountMsat);
        return wire.wire_ldk_node_send_payment_using_amount(
            port_, arg0, arg1, arg2);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_payment_hash,
      ...
      constMeta: kLdkNodeSendPaymentUsingAmountConstMeta,
      argValues: [that, invoice, amountMsat],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kLdkNodeSendPaymentUsingAmountConstMeta =>
      const TaskConstMeta(
        debugName: "ldk_node_send_payment_using_amount",
        argNames: ["that", "invoice", "amountMsat"],
      );
  ...
  Future<PaymentHash> ldkNodeSendSpontaneousPayment(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kLdkNodeSendSpontaneousPaymentConstMeta,
  ...
  TaskConstMeta get kLdkNodeSendSpontaneousPaymentConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> ldkNodeSendSpontaneousPaymentProbes(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        var arg1 = cst_encode_u_64(amountMsat);
        var arg2 = cst_encode_box_autoadd_public_key(nodeId);
        return wire.wire_ldk_node_send_spontaneous_payment_probes(
            port_, arg0, arg1, arg2);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_unit,
      ...
      constMeta: kLdkNodeSendSpontaneousPaymentProbesConstMeta,
      argValues: [that, amountMsat, nodeId],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kLdkNodeSendSpontaneousPaymentProbesConstMeta =>
      const TaskConstMeta(
  ...
  Future<Txid> ldkNodeSendToOnchainAddress(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_ldk_node_send_to_onchain_address(
            port_, arg0, arg1, arg2);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_txid,
      ...
      constMeta: kLdkNodeSendToOnchainAddressConstMeta,
  ...
  TaskConstMeta get kLdkNodeSendToOnchainAddressConstMeta =>
      const TaskConstMeta(
  ...
  Future<int> ldkNodeSpendableOnchainBalanceSats(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_ldk_node(that);
        return wire.wire_ldk_node_spendable_onchain_balance_sats(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_u_64,
        decodeErrorData: dco_decode_node_exception,
      ),
      constMeta: kLdkNodeSpendableOnchainBalanceSatsConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kLdkNodeSpendableOnchainBalanceSatsConstMeta =>
      const TaskConstMeta(
        debugName: "ldk_node_spendable_onchain_balance_sats",
        argNames: ["that"],
      );
  ...
  Future<int> ldkNodeTotalOnchainBalanceSats(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_ldk_node(that);
        return wire.wire_ldk_node_total_onchain_balance_sats(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_u_64,
        decodeErrorData: dco_decode_node_exception,
      ),
      constMeta: kLdkNodeTotalOnchainBalanceSatsConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kLdkNodeTotalOnchainBalanceSatsConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> socketAddressAsString(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_socket_address_as_string(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
        decodeErrorData: null,
      ),
      constMeta: kSocketAddressAsStringConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kSocketAddressAsStringConstMeta => const TaskConstMeta(
        debugName: "socket_address_as_string",
        argNames: ["that"],
      );
  ...
  Future<SocketAddress> socketAddressFromStr(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire_socket_address_from_str(port_, arg0);
      },
      codec: DcoCodec(
