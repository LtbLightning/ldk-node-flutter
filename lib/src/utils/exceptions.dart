...
BuilderException mapFfiBuilderError(error.FfiBuilderError e) {
  switch (e) {
    ...
    case error.FfiBuilderError.invalidParameter:
      return BuilderException(code: "InvalidParameter",
          errorMessage: "Invalid parameter provided.");
    case error.FfiBuilderError.runtimeSetupFailed:
      return BuilderException(code: "RuntimeSetupFailed",
          errorMessage: "Runtime setup failed.");
    case error.FfiBuilderError.asyncPaymentsConfigMismatch:
      return BuilderException(code: "AsyncPaymentsConfigMismatch",
          errorMessage: "Async payments configuration mismatch.");
...
LdkFfiException mapFfiNodeError(error.FfiNodeError e) {
  return e.map(
      ...
      invalidBlockHash: (_) =>
          ValidationException(code: "InvalidBlockHash", errorMessage: "The given block hash is invalid."),
      ...
      channelSplicingFailed: (e) {
        return ChannelException(code: "ChannelSplicingFailed", errorMessage: "A channel could not be spliced.");
      },
      invalidBlindedPaths: (e) {
        return ValidationException(code: "InvalidBlindedPaths", errorMessage: "The given blinded paths are invalid.");
      },
      asyncPaymentServicesDisabled: (e) {
        return NodeException(code: "AsyncPaymentServicesDisabled", errorMessage: "Asynchronous payment services are disabled.");
      },
      creationError: (e) {
