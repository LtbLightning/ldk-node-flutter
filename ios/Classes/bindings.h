...
void wire_start_ldk_node(int64_t port_, struct wire_LdkLiteInstance ldk_lite_instance);
...
void wire_get_node_info(int64_t port_, struct wire_LdkLiteInstance ldk_lite_instance);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_start_ldk_node);
