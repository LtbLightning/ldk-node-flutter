...
#[derive(Debug, Clone)]pub struct MnemonicBase {
...
pub fn finalize_builder(
    ...
    match builder?.build() {
        Ok(e) => Ok(NodeBase{ptr:RustOpaque::new(e)}),
        Err(e) => Err(e.into()),
    }
}
...
impl NodeBase {
    ...
    pub fn new_onchain_address(&self) -> anyhow::Result<Address, NodeException> {
        self.ptr.new_onchain_address().map_err(|e| e.into()).map(|e| e.into())
    }
    ...
    pub fn spendable_onchain_balance_sats(&self) -> anyhow::Result<u64, NodeException> {
        self.ptr.spendable_onchain_balance_sats().map_err(|e| e.into())
    }
    ...
    pub fn send_to_onchain_address(
        ...
        amount_sats: u64,
         ...
         self
            .ptr
            .send_to_onchain_address(&address.into(), amount_sats).map_err(|e| e.into()).map(|e| Txid{ hash: e.to_string() })
    ...
    pub fn send_all_to_onchain_address(
        ...
        self
            .ptr
            .send_all_to_onchain_address(&address.into()).map_err(|e| e.into()).map(|e| e.into())
    ...
    pub fn connect(
        ...
        self
            .ptr
            .connect(node_id.into(), address.into(), persist).map_err(|e| e.into())
    ...
    pub fn update_channel_config(
        ...
        self.ptr.update_channel_config(
            &channel_id.into(),
    ...
    pub fn send_payment(
        ...
        self.ptr.send_payment(&invoice.into()).map_err(|e| e.into()).map(|e| e.into())
    }
    ...
    pub fn send_payment_using_amount(
        ...
        amount_msat: u64,
         ...
         self.ptr.send_payment_using_amount(&invoice.into(), amount_msat) .map_err(|e| e.into()).map(|e| e.into())
    }
    ...
    pub fn send_payment_probes(&self, invoice: Bolt11Invoice) -> anyhow::Result<(), NodeException> {
        self.ptr.send_payment_probes(&invoice.into()).map_err(|e| e.into())
    }
    ...
    pub fn receive_variable_amount_payment(
        ...
        expiry_secs: u32,
         ...
         self.ptr
            .receive_variable_amount_payment(description.as_str(), expiry_secs).map_err(|e| e.into()).map(|e| Bolt11Invoice {
    ...
    pub fn remove_payment(&self, payment_hash: PaymentHash) -> anyhow::Result<(), NodeException> {
         self.ptr
            .remove_payment(&(payment_hash.into())).map_err(|e| e.into())
